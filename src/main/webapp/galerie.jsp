<%@ taglib prefix="tag" tagdir="/WEB-INF/tags"%>
		...
		<div id="section" class="carousel slide" data-ride="carousel">
			...
			<div id="carousel-inner-1" class="carousel-inner">
				<div class="carousel-item active">
					...
					<div class="carousel-caption">
						<p class="responsive-text-2">Hamacs une place</p>
					</div>
				</div>
				<div class="carousel-item">
					<img src="img/hamac2.jpg">
					<div class="carousel-caption">
						<p class="responsive-text-2">Hamacs 2 places</p>
					</div>
				</div>
				<div class="carousel-item">
					<img src="img/mer1.jpg">
					<div class="carousel-caption">
						<p class="responsive-text-2">Chambres pour hamac</p>
					</div>
				</div>
				<div class="carousel-item">
				...
				<div class="carousel-item">
					<img src="img/hamac4.jpg">
					<div class="carousel-caption">
						<p class="responsive-text-2">Structures bois pour hamac</p>
					</div>
				</div>
				<div class="carousel-item">
			...
			<div id="carousel-inner-2" class="carousel-inner">
				<img src="img/hamac1.jpg">
				<p class="responsive-text-2"><b>Hamacs une place</b></p>
				<hr>
				<img src="img/hamac2.jpg">
				<p class="responsive-text-2">Hamacs 2 places</p>	
				<hr>
