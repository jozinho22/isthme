...
<div id="section">
	<div class="card">
		<div id="collapse-header-0" class="card-header">
			<h5 class="mb-0">
				<button class="btn btn-link" data-toggle="collapse"
					data-target="#collapse-0" aria-expanded="true"
					aria-controls="collapse-0">Le concept</button>
			</h5>
		</div>

		<div id="collapse-0" class="collapse show"
			aria-labelledby="headingZero" data-parent="#section">
			<div id="img-right" class="card-body">
				<p>
					<img src="img/sacs.jpg"> Anim pariatur cliche reprehenderit,
		...
		<div id="collapse-header-n" class="card-header">
			<h5 class="mb-0">
				<button class="btn btn-link" data-toggle="collapse"
					...
					aria-controls="collapse-1">Hamacs de différentes tailles</button>
			</h5>
		</div>
	...
	<div class="card">
		...
		<div id="collapse-2" class="collapse" aria-labelledby="headingTwo"
			data-parent="#section">
			<div id="img-right" class="card-body">
				<p>
					<img class="img-responsive" src="img/mer1.jpg"> Anim pariatur
