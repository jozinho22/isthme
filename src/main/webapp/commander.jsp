...
<div id="section">
	<div class="card shopping-cart">
		...
		<div class="card-body">
			...
			<div class="row">
				<div id="image-product" class="col-12 col-sm-4 col-md-4 text-center">
					<img src="img/mer1.jpg" width="120" height="80">
				</div>
				<div class="col-12 text-sm-center col-sm-4 text-md-left col-md-4">
					<div class="desc">
				...
				<form action="inscription" method="POST">
					...
					<div class="row">
						<div class="col-12 col-sm-6 col-md-6 text-center">
							<label for="message-text" class="col-form-label">Votre
								nom</label> <input name="nom" class="form-control"
								placeholder="Gicqueau">
						</div>
					</div>
					<div class="row">
						<div class="col-12 col-sm-6 col-md-6 text-center">
							<label for="message-text" class="col-form-label">Votre
								prénom</label> <input name="prenom" type="text" class="form-control"
								placeholder="Teddy">
						</div>
					</div>
					<label for="message-text" class="col-form-label">Votre
						email</label> <input name="email" class="form-control"
						placeholder="name@example.com" value="moi@gmail.com"> <label
						for="message-text" class="col-form-label">Numéro de
						téléphone</label> <input name="tel" type="tel" class="form-control"
						placeholder="0612345678">
					<div class="form-group">
						<label for="message-text" class="col-form-label">Adresse
							de livraison:</label>
						<textarea name="adresse" class="form-control" id="message-text"></textarea>
					</div>
					<div class="modal-footer">
						<button onclick="sendMontant();" type="submit"
							class="btn btn-primary">Paypal</button>
					</div>
				</form>
			</div>
